/**
 * @ngdoc controller
 * @name facilityManagementPocApp.controller:AppController
 * @description
 * This is the application wide controller of the facilityManagementPocApp application
 */
...
(function () {
	...
	angular
		.module('facilityManagementPocApp')
		.controller('AppController', AppController);

	/**
	 * @ngdoc function
	 * @name facilityManagementPocApp.provider:AppController
	 * @description
	 * Provider of the {@link facilityManagementPocApp.controller:AppController AppController}
	 *
	...
	function AppController(Auth, $mdSidenav) {
		 ...
		 * @ngdoc function
		 * @name logout
		 * @methodOf facilityManagementPocApp.controller:AppController
		 * @description
