(function () {
	...
	/**
	 * Introduce the facilityManagementPocApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {facilityManagementPocApp.admin.user.list}
	 * @requires {facilityManagementPocApp.admin.user.create}
	 */
	angular
		.module('facilityManagementPocApp.admin.user', [
			'ngResource',
			'ui.router',
			'facilityManagementPocApp.admin.user.list',
			'facilityManagementPocApp.admin.user.create'
		])
