/**
 * @ngdoc overview
 * @name facilityManagementPocApp.admin.user.list.detail
 * @description
 * The `facilityManagementPocApp.admin.user.list.detail` module which provides:
 *
 * - {@link facilityManagementPocApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires facilityManagementPocApp.auth.user
 */
(function () {
	'use strict';
	...
	angular
		.module('facilityManagementPocApp.admin.user.list.detail', [
			'ui.router',
			'angularMoment',
			'facilityManagementPocApp.auth.user'
		])
