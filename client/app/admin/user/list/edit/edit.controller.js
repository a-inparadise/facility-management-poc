/**
 * @ngdoc controller
 * @name facilityManagementPocApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name facilityManagementPocApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link facilityManagementPocApp.admin.user.list.edit.controller:UserEditController UserEditController}
