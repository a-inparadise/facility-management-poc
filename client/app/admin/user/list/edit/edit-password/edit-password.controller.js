/**
 * @ngdoc controller
 * @name facilityManagementPocApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
	...
	angular
		.module('facilityManagementPocApp.admin.user.list.edit')
		.controller('EditPasswordController', EditPasswordController);


	/**
	 * @ngdoc function
	 * @name facilityManagementPocApp.admin.user.list.edit.provider:EditPasswordController
	 * @description
	 * Provider of the {@link facilityManagementPocApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 *
	 ...
	 * @returns {Service} {@link facilityManagementPocApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 */
	...
	function EditPasswordController($mdDialog, UserService, user, Toast) {
		 ...
		 * @ngdoc function
		 * @name changePassword
		 * @methodOf facilityManagementPocApp.admin.user.list.edit.controller:EditPasswordController
		 * @description
