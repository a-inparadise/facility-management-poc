/**
 * @ngdoc overview
 * @name facilityManagementPocApp.admin.user.list.edit
 * @description
 * The `facilityManagementPocApp.admin.user.list.edit` module which provides:
 *
...
(function () {
	...
	angular
		.module('facilityManagementPocApp.admin.user.list.edit', [
			...
			'facilityManagementPocApp.repeatInput',
