/**
 * @ngdoc controller
 * @name facilityManagementPocApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name facilityManagementPocApp.admin.user.list.items.provider:UserItemsController
	 * @description
	 * Provider of the {@link facilityManagementPocApp.admin.user.list.items.controller:UserItemsController UserItemsController}
	 *
	 */
	...
	function UserItemsController($state, Auth) {
		 ...
		 * @ngdoc function
		 * @name isSelected
		 * @methodOf facilityManagementPocApp.admin.user.list.items.controller:UserItemsController
		 * @description
