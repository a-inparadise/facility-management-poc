/**
 * @ngdoc controller
 * @name facilityManagementPocApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('facilityManagementPocApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name facilityManagementPocApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link facilityManagementPocApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link facilityManagementPocApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf facilityManagementPocApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf facilityManagementPocApp.admin.user.create.controller:UserCreateController
		 * @description
