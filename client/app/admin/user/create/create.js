/**
 * @ngdoc overview
 * @name facilityManagementPocApp.admin.user.create
 * @description
 * The `facilityManagementPocApp.admin.user.create` module which provides
 *
 * - {@link facilityManagementPocApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
	...
	angular
		.module('facilityManagementPocApp.admin.user.create', [
			...
			'ngMessages',
			'ngMaterial',
			'facilityManagementPocApp.auth',
			'facilityManagementPocApp.toast',
			'facilityManagementPocApp.remoteUnique',
			'facilityManagementPocApp.mongooseError'
		])
