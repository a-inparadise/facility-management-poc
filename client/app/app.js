/**
 * @ngdoc overview
 * @name facilityManagementPocApp
 * @description
 * Module definition for the facilityManagementPocApp module.
 */
...
(function () {
	...
	angular
		.module('facilityManagementPocApp', [
			...
			'ui.router',
			'btford.socket-io',
			'facilityManagementPocApp.lodash',
			'facilityManagementPocApp.mainMenu',
			'facilityManagementPocApp.io',
			'facilityManagementPocApp.socket',
			'facilityManagementPocApp.auth',
			'facilityManagementPocApp.admin',
			'facilityManagementPocApp.account',
			'facilityManagementPocApp.main'
		])
		.config(appConfig)
		.run(appRun);
